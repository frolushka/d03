...
public class TowerScript : MonoBehaviour {
	...
	public bool CanKillFlyingEnemies
		=> type == Type.gatling || type == Type.rocket;
	...
	{
		if (bot.CompareTag("bot") || bot.CompareTag("boss") || CanKillFlyingEnemies && bot.CompareTag("flybot"))
			botsList.Add(bot.gameObject);
	}

	private void OnTriggerExit2D(Collider2D bot) 
	{
		if (bot.CompareTag("bot") || bot.CompareTag("boss") || CanKillFlyingEnemies && bot.CompareTag("flybot"))
